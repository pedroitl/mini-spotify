        ...
        do {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    Midias midia = new Midias(titulo, artista, duracao, genero);
                ...
                case 3:
                    ...
                    catalogo.removerMidia(tituloRemover);
                    break;

                case 4:
                    System.out.print("Digite título/autor/gênero para buscar: ");
                    try {
                        Midia midia = menuMidia(sc);
                        if (midia != null) {
                            midia.exibirInfo();
                        } else {
                            System.out.println("Nenhuma mídia encontrada.");
                        }
                    } catch (OpcaoInvalidaException | ListaVaziaException | EntradaVaziaException e) {
                ...
                case 8:
                    ...
                    if (u1 != null) {
                        ...
                        Playlist playlist = u1.getPlaylist(nomePl);
                        ...
                        if (playlist != null) {
                            ...
                            do {
                                ...
                                switch (opPl) {
                                    case 1:
                                        System.out.print("Título da mídia para adicionar: ");
                                        String midiaAdd = sc.nextLine();
                                        Midia mAdd = catalogo.buscarPorTitulo(midiaAdd);
                                        if (mAdd != null) {
